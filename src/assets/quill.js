//This file is a slightly edited copy of quill.js from the node_modules
//I had to make a small change to make it work with the sidebar, so I had to commit this file
...
var BubbleTooltip = function (_BaseTooltip) {
  ...
  _createClass(BubbleTooltip, [{
    ...
    value: function position(reference) {
	  ...
	  //HERE IS THE CHANGE
	  if(this.root.style.left.substring(0,this.root.style.left.length-2) < -30){ this.root.style.left = '-30px'; }
